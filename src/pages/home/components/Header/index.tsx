...
export default function Header() {
    ...
    const ethEnabledWeb3 =async () => {
        if (typeof window.ethereum !== 'undefined') {
            ...
            const signRes = await web3.eth.personal.sign(web3.utils.utf8ToHex(message), account, '') // MetaMask will ignore the password argument here
            axios.post(`http://127.0.0.1:9125/api/auth/metamask`, { 
    ...
    const ethEnabled = async () => {
      ...
      if(walletAddress) {
        ...
        btn = <Button className="headerWallet" type="primary" onClick={ethEnabledWeb3} loading={btnLoading} >Connect Wallet</Button>
      }
